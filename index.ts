  ...
  if (pinAnswer.pin === myPin) {
    ...
    if (operationAns.operation === "Fast Cash") {
      ...
      if (fastCashAns.fastCash > myBalance) {
        ...
        console.log(
          chalk.green(`${fastCashAns.fastCash} withdrawal Successfully`)
        );
        console.log(
          chalk.blueBright.bold(`Your remaining balance is: $${myBalance}`)
        );
      }
      ...
      if (cashWithdrawalAns.cashWithdrawal > myBalance) {
        ...
        console.log(
          chalk.green(
            `${cashWithdrawalAns.cashWithdrawal} withdrawal Successfully`
          )
        );
        console.log(
          chalk.blueBright.bold(`Your remaining balance is: $${myBalance}`)
    ...
    attempts--;
    console.log(
      chalk.red(`Incorrect pin code, ${attempts} attempts remaining. Try again`)
    );
    if (attempts === 0) {
      console.log(
        chalk.red(
